...
/**
 * This is the model cl ass for table "user_master".
 *
...
class UserMaster extends CActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            ...
            array('is_active, is_busy, is_logged_in', 'numerical', 'integerOnly' => true),
            array('name, email, pass, os', 'length', 'max' => 50),
            array('mobile', 'length', 'max' => 10, 'min' => 10),
            // The following rule is used by search().
            // @todo Please remove those attributes that should not be searched.
            array('id, name, email, mobile, pass, device_token, os, is_active, is_logged_in', 'safe', 'on' => 'search'),
        );
    }
    ...
    public function relations() {
        ...
        return array(
            'transactionMasters' => array(self::HAS_MANY, 'TransactionMaster', 'user_id'),
        );
    }
